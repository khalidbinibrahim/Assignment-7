            ...
            <div className="border-2 border-gray-300 rounded-xl">
                <div className="py-6">
                    <div className="font_lexend">
                        <h3 className="font-medium text-2xl text-center mb-4">Want to cook: 01</h3>
                    </div>
                    <hr />
                    <div>
                            ...
                            <table className="table font_fira_sans text-[#282828B3]">
                                ...
                                <tbody>
                                    ...
                                    <tr className="bg-base-200">
                                        ...
                                        <td>20 minutes</td>
                                        <td>400 calories</td>
                                        <td><a className="btn text-xl font_lexend font-medium rounded-full text-[#150B2B] bg-[#0BE58A] border-none">Preparing</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
